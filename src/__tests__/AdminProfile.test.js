...
const dummyData = {
	...
	accessToken: encryptByAES("uhndskanda"),
	refreshToken:encryptByAES("ajbsasaiksa"),
	expireTime:encryptByAES(12455)
};
*/
...
describe('Admin Profile', () => {
  ...
  it('edit function', () => {
	...
	it('submit button is called', () => {
		Cookies.set('adminData', encryptByAES(JSON.stringify([dummyData])));
