...
import Header from "./../../molecules/header/Agent.jsx";
 ...
 * This file is responsible for making the header and footer template for role:"AGENT"
 * which is always rendered in every page.
 */

class AgentTemplate extends React.Component {
	constructor(props) {
		super(props);
		this.state = {
			user: "loading"
	...
	componentDidMount = () => {
		if (Cookies.get("agentData") === undefined) {
