...
export default class CustomerProfile extends React.Component {
	constructor(props) {
		...
		let profileData = {};
		try {
			profileData = JSON.parse(decryptByAES(Cookies.get('customerData')))[0];
		}
		catch (e) {
			profileData = {
				firstName: '',
	...
	submitProfile(e) {
		...
		if (formValid(this.state)) {
			let user = {
				"id": encryptByAES((JSON.parse(decryptByAES(Cookies.get('customerData')))[0].id)),
				...
				"status": JSON.parse(decryptByAES(Cookies.get('customerData')))[0].status,
				"password": encryptByAES("Abcde@123"),
				"accessToken": JSON.parse(decryptByAES(Cookies.get('customerData')))[0].accessToken,
				"refreshToken": JSON.parse(decryptByAES(Cookies.get('customerData')))[0].refreshToken,
				"expireTime": JSON.parse(decryptByAES(Cookies.get('customerData')))[0].expireTime
			}
			...
			axios.put(url, user)
				.then(
					response => {
						...
						Cookies.set('customerData', encryptByAES(JSON.stringify([user])));
						...
						<div className="Oms">
							...
							<Form className="MyForm register-form">
								<Form.Group as={Row} controlId="username">
									...
									<Col sm={8} md={9}>
										<Form.Control className="input" name="username" type="text" defaultValue={this.state.username} ref="username" readOnly required />
									</Col>
								</Form.Group>
								...
								<Form.Group as={Row} controlId="role">
									...
									<Col sm={8} md={9}>
										<Form.Control className="input" name="role" type="text" defaultValue={this.state.role} ref="role" readOnly required />
									</Col>
								</Form.Group>
								...
								<Form.Group as={Row} controlId="firstName">
									...
									<Col sm={8} md={9}>
										<Form.Control className="input firstName" name="firstName" type="text" defaultValue={this.state.firstName} ref="firstName" readOnly={!this.state.readOnly} onChange={this.handleChange} required />
								...
								<Form.Group as={Row} controlId="lastName">
									...
									<Col sm={8} md={9}>
										<Form.Control className="input lastName" name="lastName" type="text" defaultValue={this.state.lastName} ref="lastName" readOnly={!this.state.readOnly} onChange={this.handleChange} required />
								...
								<Form.Group as={Row} controlId="dateOfBirth">
									...
									<Col sm={8} md={9}>
										...
										<Form.Control id="dob1" className="input dateOfBirth" name="dateOfBirth" type="text" onFocus={this.onfocus} defaultValue={this.state.dateOfBirth} ref="dateOfBirth" readOnly={!this.state.readOnly} onChange={this.handleChange} required />
								...
								<Form.Group as={Row} controlId="phone">
									...
									<Col sm={8} md={9}>
										<Form.Control className="input phone" name="phone" type="number" defaultValue={this.state.phone} ref="phone" readOnly={!this.state.readOnly} onChange={this.handleChange} required />
								...
								<Form.Group as={Row} controlId="mail">
									...
									<Col sm={8} md={9}>
										<Form.Control className="input mail" name="mail" type="email" defaultValue={this.state.mail} ref="mail" readOnly={!this.state.readOnly} onChange={this.handleChange} required />
								...
								<Form.Group as={Row} controlId="addressLine1">
									...
									<Col sm={8} md={9}>
										<Form.Control className="input addressLine1" name="addressLine1" type="text" defaultValue={this.state.addressLine1} ref="addressLine1" readOnly={!this.state.readOnly} onChange={this.handleChange} required />
								...
								<Form.Group as={Row} controlId="addressLine2">
									...
									<Col sm={8} md={9}>
										<Form.Control className="input addressLine2" name="addressLine2" type="text" defaultValue={this.state.addressLine2} ref="addressLine2" readOnly={!this.state.readOnly} onChange={this.handleChange} required />
								...
								<Form.Group as={Row} controlId="state">
									...
									<Col sm={8} md={9}>
										<Form.Control className="input state" name="state" type="text" defaultValue={this.state.state} ref="state" readOnly={!this.state.readOnly} onChange={this.handleChange} required />
								...
								<Form.Group as={Row} controlId="country">
									...
									<Col sm={8} md={9}>
										<Form.Control className="input country" name="country" type="text" defaultValue={this.state.country} ref="country" readOnly={!this.state.readOnly} onChange={this.handleChange} required />
								...
								<Form.Group as={Row} controlId="pincode">
									...
									<Col sm={8} md={9}>
										<Form.Control className="input pincode" name="pincode" type="number" defaultValue={this.state.pincode} ref="pincode" readOnly={!this.state.readOnly} onChange={this.handleChange} required />
								...
								{this.state.edit == true && (
									<div className="editProfileDiv">
										<Button className="RegisterButton" variant="primary" id="submitProfile" type="submit" onClick={this.submitProfile}>Submit</Button>
										<span></span>
