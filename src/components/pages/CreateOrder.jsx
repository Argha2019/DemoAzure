...
getComponent() {
    ...
    refresh() {
        ...
        this.props.history.push('/loginAgent');
    }
        ...
        return (
            <AgentTemplate>
                ...
                <div>
                    ...
                    <Card className="wrapper2" style={{marginLeft:"22%" , width : "53.3%" , color:"white" } } >
                                <h6 style={{alignContent : "left"}}>Type of user</h6>
                                <Row className="addProduct">
                                    <Col sm={1} md={4}>
                                        <Row>
                                            <Col sm={1} md={4}>
                                                <Form.Check type="radio" aria-label="radio 1" checked={!this.state.guest} onChange={this.handleRadio} />
                                            </Col>
                                            <Col sm={1} md={8}>
                                                Customer
                </Col>
                                        ...
                                        {!this.state.guest &&
                                            <div>
                                                <br />
                                                <Form id="searchCustomer" onSubmit={this.searchCustomer}>
                                                    <input type="text" className="inputProduct" id="searchCustInput" name="searchcust" placeholder="Enter username" value={this.state.customerUsername} onChange={this.handleSearchCustomer} style={{ height: "2.3rem" , width: "11.5rem" , marginLeft: "-38%" }} required />
                                                    {(this.state.loadingCustomer === "loading") && <Spinner animation="border" style={{ width: "1rem", height: "1rem" , color: "white"}} />}
                                                    {(this.state.loadingCustomer === "verified") && <i className="fa fa-check" aria-hidden="true" style={{ color: "white" }}></i>}
                                                    <Button type="submit" style={{height: "2.3rem" , width:"2.5rem"}} ><i className="fa fa-search" aria-hidden="true"></i></Button>
                                                </Form>
                                                <br />
                                                <br />
                                            </div>
